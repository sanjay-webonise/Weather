...
public class LookNFeelChooser extends Application {
    ...
    @Override public void init() {
        Font.loadFont(LookNFeelChooser.class.getClassLoader().getResourceAsStream("ttf/Roboto-Thin.ttf"), 10).getName();
        Font.loadFont(LookNFeelChooser.class.getClassLoader().getResourceAsStream("ttf/Roboto-Light.ttf"), 10).getName();
    }

    @Override public void start(Stage primaryStage) throws IOException {
        BorderPane root    = new BorderPane();
        Parent     content = FXMLLoader.load(getClass().getClassLoader().getResource("fxml/lnf_demo.fxml"));
        ...
        style1MenuItem.setOnAction(ae -> {
            ...
            scene.getStylesheets()
                 ...
                 .getResource("css/controlStyle1.css")
                 .toExternalForm());
        });
        ...
        style2MenuItem.setOnAction(ae -> {
            ...
            scene.getStylesheets()
                 .add(getClass().getClassLoader()
                 .getResource("css/controlStyle2.css")
                 .toExternalForm());
        });
